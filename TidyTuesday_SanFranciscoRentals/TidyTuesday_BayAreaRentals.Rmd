...
# **Introduction**
The question of interest is: **How do different factors affect the rental prices of apartments in the Bay Area?**. We thus want to study the relationship of different predictor variables including features of the apartment and spatial and temporal effects, on the response variable, price. The rent dataset provided by TidyTuesday contains information about the rental properties in the Bay Area such as rental price, number of beds, number of baths, square footage, county, city, neighbourhood, descriptions, etc. The dataset was compiled by Dr. Kate Pennington in which she turned to Craigslist, a major platform for the United States rental market and Wayback Machine, a web archive, which provided snapshots of Craigslist apartment listings from September 2000 to July 2018 (Pennington, 2018).  However, it's essential to acknowledge certain limitations -- The data may not represent the entire rental market, potentially missing extremes such as high-end properties or those communicated through word of mouth, and the temporal and spatial coverage is not continuous, as the Wayback Machine archives websites sporadically (Pennington, 2018). 
...
# **Data Visualisations**
## Visualisation 1: Yearly Trend of Rental Prices in Different Counties
...
## Visualisation 2: Relationship between Size of Living Area and Rental Price
...
## Visualisation 3: Trend of prices across seasons
